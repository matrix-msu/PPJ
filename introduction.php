<?php
    ...
    $issue_kid = $_GET['kid'];
    $issue = KORA_Search(token, projectID, Issue, new \KORA_Clause('KID', '=', $issue_kid), array('Introduction'), array());
...
<div id="main" class="journalSingleVolume">
	...
	<?php echo $post->post_content; ?>
        <div id="volumeContent">
            ...
            <h1>Introduction</h1>
            <p id="introduction_text"><?php echo $issue[$issue_kid]['Introduction']; ?></p>
        </div>
